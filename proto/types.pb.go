...
type Header struct {
	...
	Height    int32  `protobuf:"varint,2,opt,name=height,proto3" json:"height,omitempty"` // id of the block
...
type TxInput struct {
	...
	PrevTxHash   []byte `protobuf:"bytes,1,opt,name=prevTxHash,proto3" json:"prevTxHash,omitempty"`      // the previous hash of the transaction containing the output we want to spend
	PrevOutIndex uint32 `protobuf:"varint,2,opt,name=prevOutIndex,proto3" json:"prevOutIndex,omitempty"` // index of the output of the previous transaction we want to spend
...
var file_proto_types_proto_rawDesc = []byte{
	...
	0x70, 0x75, 0x74, 0x52, 0x07, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x42, 0x1a, 0x5a, 0x18,
	0x77, 0x6f, 0x79, 0x74, 0x65, 0x63, 0x6b, 0x2e, 0x70, 0x6c, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b,
